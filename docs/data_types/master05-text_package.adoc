...
make inferences about specific things found in the record. For instance if the term "pneumonia" is
found, queries to the terminology service can be made in order to deduce that the patient has both a
"infection" and a "disease of the respiratory system" (assuming pneumonia is classified under these more
